...
- [ ] 5.4 Verify theme persists across app restarts (requires manual runtime test)
- [ ] 5.5 Verify tab switching works for all 6 tabs including keyboard shortcuts (requires manual runtime test)
