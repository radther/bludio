...
Manage Bluetooth audio codec discovery and switching via PulseAudio's messaging API. Provides the backend for codec selection on the Configuration page.
