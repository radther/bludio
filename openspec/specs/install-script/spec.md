...
Provide a POSIX-compliant shell script that downloads and installs Bludio from GitHub Releases, supporting both system-wide and user-local installation with architecture detection.
